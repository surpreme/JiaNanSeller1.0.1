 ...
 * @description:
 */
public abstract class BaseObserver2<T> implements Observer<BaseData2<T>> {

    protected Context context;
    private String labelTxt;

    public BaseObserver2(Context mContext, String labelTxt) {
    ...
    public BaseObserver2(Context mContext) {
        this.context = mContext;
    }
    ...
    //获取数据
    @Override
    public void onNext(BaseData2<T> value) {
